...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='seal2noseal', help='path of the dataset')
...
parser.add_argument('--sample_dir', dest='sample_dir', default='./data/sample', help='sample are saved here')
